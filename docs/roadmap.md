...
Mapeamento das seções do [README principal](../README.md) para pastas de **documentação** e **código**. A ordem favorece o estudo progressivo; a organização por pastas segue a taxonomia **Gang of Four** (criação, estrutura, comportamento).

## Trilha foundation (seções 1–3)

| Ordem | Seção no README | Pasta de artigo |
|-------|-----------------|-----------------|
| 1 | Introdução aos Design Patterns | [foundation/01-introducao-design-patterns](foundation/01-introducao-design-patterns/) — artigo: [artigo.md](foundation/01-introducao-design-patterns/artigo.md) |
